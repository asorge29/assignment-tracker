      ...
      <DialogContent>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-row gap-1 w-full justify-center">
            <div className="relative w-10 h-10 rounded-full border bg-white cursor-pointer overflow-hidden -rotate-[35deg] flex items-center justify-center" onClick={() => refetchSettings({...settings, accentColor: undefined})}>
